...
namespace _4_5
{
    internal class Program
    {
        ...
        {
            //array 2d des types de tornades
            string[,] fujita = { { "F0", "Dégâts légers : certains dommages sont subis par les cheminées, les antennes de télévision, les bardeaux, les arbres, les enseignes et les fenêtres." }, 
